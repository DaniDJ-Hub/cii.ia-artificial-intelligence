    ...
    >
      ...
      >
        <motion.img
          src={imageSrc}
          alt={altText}
          className="absolute left-0 top-0 h-full w-full rounded-2xl object-cover will-change-transform [transform:translateZ(0)]"
      ...
      {showTooltip && (
        <motion.figcaption
          className="pointer-events-none absolute left-0 top-0 z-[3] hidden rounded-md bg-[var(--surface-raised)] px-2.5 py-1 text-[11px] text-[var(--text-primary)] opacity-0 sm:block"
