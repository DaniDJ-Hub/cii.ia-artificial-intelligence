...
export const ContactModal: React.FC<ContactModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Brief, honest loading state while the request is registered in the HUB
    window.setTimeout(() => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/85 backdrop-blur-md overflow-y-auto perspective-container">
      <motion.div
        ...
        className="relative w-full max-w-2xl rounded-xl glass-panel-strong glow-accent-lg p-6 sm:p-10 my-8 text-left"
      ...
      >
        ...
        {step === 1 && (
          <div>
            ...
            {/* Fast path: leave just your institutional email and jump straight to step 2 */}
            <div className="mb-6 p-4 rounded-lg glass-chip">
              <div className="text-[10px] font-mono text-[#6E737C] uppercase mb-2">O ve directo con tu correo</div>
              <CurvedInput
                  ...
                  <button
                    ...
                    className={`w-full p-3.5 rounded-lg text-left transition-all border ${
                      isSelected
                        ...
                        : 'bg-[#0A0A0B] border-white/[0.08] hover:border-[#42464E]'
                    }`}
                  >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full glass-chip rounded px-3 py-2.5 pl-9 text-xs text-white focus:outline-none focus:border-[#5CA9DB]"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full glass-chip rounded px-3 py-2.5 text-xs text-white focus:outline-none focus:border-[#5CA9DB]"
                />
              </div>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full glass-chip rounded p-2.5 text-xs text-white focus:outline-none focus:border-[#5CA9DB]"
              />
            </div>

            <div>
              <label className="block text-[11px] font-mono text-[#A8ACB3] mb-1">Brief o especificaciones (opcional)</label>
            ...
            <div className="pt-4 border-t border-white/[0.08] flex items-center justify-between">
              <button
                ...
                className="text-xs font-mono text-[#A8ACB3] hover:text-white disabled:opacity-40"
              >
                ← Volver al paso 1
              </button>
              ...
              <button
                type="submit"
                disabled={isSubmitting}
                className="h-11 px-6 rounded bg-[#5CA9DB] hover:bg-[#8CC6EC] disabled:opacity-70 text-[#0A0A0B] text-xs font-mono font-bold tracking-wider uppercase transition-all flex items-center gap-3 min-w-[220px] justify-center"
              >
                {isSubmitting ? (
                  <LoaderOne />
                ) : (
        ...
        {step === 3 && (
          <div className="text-center py-8">
            ...
            <div className="p-4 rounded glass-chip max-w-md mx-auto text-left text-xs font-mono text-[#A8ACB3] mb-6 space-y-1">
