...
export const CardContainer = ({
  ...
  return (
    <MouseEnterContext.Provider value={[isMouseEntered, setIsMouseEntered]}>
      <div className={cn('flex items-center justify-center py-10', containerClassName)} style={{ perspective: '1000px' }}>
        <div
          ref={containerRef}
...
export const CardItem = ({
  ...
  // `Tag` is a dynamic element type, so the JSX factory can't resolve a
  // precise props/ref shape here — cast to a permissive component signature.
