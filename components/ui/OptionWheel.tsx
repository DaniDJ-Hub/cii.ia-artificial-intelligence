...
const OptionWheel = ({
  ...
  return (
    <div
      ...
      role="listbox"
      tabIndex={0}
      aria-label="Selector de industrias"
    ...
    >
      {items.map((label, index) => (
        <div
          ...
          className={`absolute top-1/2 cursor-pointer whitespace-nowrap font-display leading-none will-change-[transform,opacity,filter] [font-size:var(--ow-font-size)] [color:color-mix(in_srgb,var(--ow-active-color)_calc(var(--ow-p,0)*100%),var(--ow-text-color))] ${
